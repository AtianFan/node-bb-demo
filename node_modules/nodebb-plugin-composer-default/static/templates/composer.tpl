<div component="composer" class="composer<!-- IF resizable --> resizable<!-- ENDIF resizable --><!-- IF !isTopicOrMain --> reply<!-- ENDIF !isTopicOrMain -->">
	...
	<div class="composer-container">
		...
		<div class="row title-container">
			...
			<!-- IF isTopic -->
			<div class="category-list-container col-lg-6 col-md-12 hidden-sm hidden-xs">
		...
		<div class="row col-container">
			<div class="category-tag-row col-lg-12 col-md-12">
			...
			<!-- IF bignews -->
			<div class="warn-text col-lg-12 col-md-12"><i class="fa fa-warning"></i> 提示：图片最佳比例为[19:13],否则将变形展示</div>
			<!-- ENDIF bignews -->

			<div class="write-preview-container col-lg-12 col-md-12">
				<div class="write-container maximized">
					<div class="help-text">
			...
			<!-- IF isTopicOrMain -->
			<div class="tag-row col-lg-12 col-md-12">
				<div class="tags-container">
					...
					<input class="tags" type="text" class="form-control" <!-- IF tagWhitelist.length -->disabled<!-- ENDIF tagWhitelist.length --> placeholder="[[tags:enter_tags_here, {minimumTagLength}, {maximumTagLength}]]" tabindex="5"/>
				</div>
			</div>
			<!-- ENDIF isTopicOrMain -->
		</div>

		<div class="btn-group pull-left action-bar hidden-sm hidden-xs">
			<!-- IF bignews -->
			<button class="btn btn-primary composer-submit" data-action="post" tabindex="6">[[topic:composer.bignews]]</button>
			<!-- ELSE -->
			...
			<button class="btn btn-default composer-submit" id="anonymous" data-action="post" tabindex="-1">匿名提交</button>
			<button class="pro-more hide">批量生成</button>
			
			<label class="checkbox-inline" style="margin-left: 25px;margin-top: 4px;">
                    <input type="checkbox" name="anonyCheckbox" id="anonyCheckbox">
					匿名
			</label>
		</div>
