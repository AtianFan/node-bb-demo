			...
			renderHelp: function(helpContent, callback) {
				translator.translate('[[markdown:help_text]]', function(translated) {
					var str =   '`# 一级标题`：注意符号后跟空格\n' +
								...
								'`![替代文字](图片地址)` :可以是相对地址和外部链接，如果第一次上传请使用`上传图片`按钮![0_1504175329656_上传按钮.png](/uploads/files/1504175289071-上传按钮.png) \n\n' +

								'`[链接文本](链接地址)` : 链接和图片少了一个`!`符号\n\n' +

								'`| Tables        | Are           | Cool  |`\n' +
								'`| ------------- |:-------------:| -----:|`\n' +
								'`| col 3 is      | right-aligned | $1600 |`\n' +
								'`| col 2 is      | centered      |   $12 |`\n' +
								'`| zebra stripes | are neat      |    $1 |` : 表格主要用`|`表示，第二行从左到右依次为左对齐、居中、右对齐\n\n' +
