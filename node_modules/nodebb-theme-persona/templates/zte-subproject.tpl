...
<div class="project" has-widget-class="project" has-widget-target="sidebar">
	...
	<div class="project-right">
		...
		<!-- IF gitlabData -->
		<div class="pro-item">
			<div class='sub-tit'><a href="{gitlabLink}" target="_blank"><i class="iconfont icon-daimatuoguan"></i>代码托管</a></div>
		...
		<div class="pro-item">
			<div class='sub-tit'><a href="{gitlabLink}/issues" target="_blank"><i class="iconfont icon-renwu"></i>任务</a></div>
		...
		<div class="pro-item">
			<div class='sub-tit'><a href="{gitlabLink}/milestones" target="_blank"><i class="iconfont icon-lichengbei"></i>里程碑</a></div>
		...
		<div class="pro-item">
			<div class='sub-tit'><a href="{gitlabLink}/wikis/home" target="_blank"><i class="iconfont icon-zhishiku"></i>知识库</a><span class='pro-data'>{gitlabData.wikiNums}</span></div>
		...
		<!-- ENDIF gitlabData -->
		<div class="pro-item">
			<div class='sub-tit'><a href="<!-- IF webLink -->{webLink}<!-- ENDIF webLink -->" target="_blank"><i class="iconfont icon-yanshizhandian"></i>站点演示</a></div>
			
			<span class="cl3"><!-- IF webLink -->{webLink}<!-- ENDIF webLink --></span>
		</div>
		<div class="pro-item">
			<div class='sub-tit'><a href="<!-- IF link --> {link}<!-- ELSE -->{config.relative_path}/category/{slug}<!-- ENDIF link -->" target="_blank"><i class="iconfont icon-xiangmuluntan"></i>项目论坛</a></div>
			<div>
