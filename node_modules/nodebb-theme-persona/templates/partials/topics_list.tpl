		...
		<div class="col-md-7 col-sm-9 col-xs-10 content">
			...
			<h2 component="topic/header" class="title">
				...
				<!-- IF !template.category -->
					...
					<!-- ELSE -->
					<small>
						<a href="<!-- IF topics.category.link --> {topics.category.link}<!-- ELSE -->{config.relative_path}/category/{topics.category.slug}<!-- ENDIF topics.category.link -->">
							<span class="iconBg" style="background-image:url('{topics.category.backgroundImage}')">
							</span>
							{topics.category.name}</a> &bull;
						</a>
					</small>
					<!-- ENDIF !topics.category.backgroundImage -->
